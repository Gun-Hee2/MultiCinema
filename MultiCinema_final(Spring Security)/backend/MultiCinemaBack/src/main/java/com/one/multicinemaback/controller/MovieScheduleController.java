...
public class MovieScheduleController {
	...
	// 영화 제목
	@RequestMapping(value = "/mtitle", method = RequestMethod.GET)
	...
	// 상영 시간
	@RequestMapping(value = "/mtime", method = RequestMethod.GET)
	...
	// msnum 검색한 영화정보
		@RequestMapping(value = "/mmsnum", method = RequestMethod.GET)
