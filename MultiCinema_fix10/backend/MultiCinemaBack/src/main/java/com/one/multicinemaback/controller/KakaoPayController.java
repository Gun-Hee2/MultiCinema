...
public class KakaoPayController {
	...
	public String kakaopay(String id, String product, String count, String payprice) throws UnsupportedEncodingException {
		...
		try {
			...
			String parameter = "cid=TC0ONETIME&partner_order_id=1&partner_user_id=MultiCinema&item_name=" + pname + "&quantity=" + count + "&total_amount=" + payprice + "&vat_amount=200&tax_free_amount=0&approval_url=http://localhost:8090/MultiCinemaFront/views/kakaopay/SbPaySuccess.html?id=" + id + "&fail_url=https://localhost/fail&cancel_url=https://localhost/cancel";
